...
public class LDMLLocaleWriter extends XMLWriter
{
    ...
    protected void writeIdentity(Locale locale, String message)
    {
        ...
        String version = "$Revision: 7659 $";  //tihs is the CVS version not the CLDR version
        String msgStr = "";
        ...
        String generationStr = "<" + LDMLConstants.GENERATION + " " + LDMLConstants.DATE + "=\"$Date: 2012-08-29 16:09:25 -0700 (Wed, 29 Aug 2012) $\"/>";
